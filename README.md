...
Telescope, and are frozen against the Laravel release they were taken from — 13.26.1, the floor of the
`^13.26.1` that `composer.json` requires — so each carries the checksum of the file behind it. A release that touches either file leaves
